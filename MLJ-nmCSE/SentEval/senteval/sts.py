...
class STSEval(object):
    ...
    def run(self, params, batcher):
        ...
        for dataset in self.datasets:
            ...
            # np.save('predict_score_bert.npy',sys_scores)
            # np.save('golden_score_bert.npy', gs_scores)
            # input('保存完成')
...
class STS12Eval(STSEval):
    def __init__(self, taskpath, seed=3407):
...
class STSBenchmarkEval(STSEval):
    def __init__(self, task_path, seed=3407):
